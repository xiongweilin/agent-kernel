...
class StateStore(Protocol):
    ...
    # Canonical knowledge path.  Legacy ``list_knowledge`` remains a
    # read-compatibility view and must not be used for new writes.
    ...
    # V1.1 Execution Integrity extensions (optional for conformance, default fallback)
