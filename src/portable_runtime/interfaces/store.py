...
class StateStore(Protocol):
    ...
    # Atomic terminal primitive.  The store owns proof validation and the
    # paired Work/Run commit; callers cannot open a context and then write an
    # arbitrary terminal object.
    def commit_terminal(self, work: Work, run: Run, verification_refs: list[str]) -> Run: ...
    def commit_verified_outcome(self, request: VerifiedOutcomeCommitRequest) -> BaseRecord: ...
