...
class RecoveryReconciliationConsumer:
    ...
    async def consume(
        ...
        # A-first is semantic.  Once durable completion exists, no registry,
        # current B, or current C state may reopen the responsibility.
        try:
        ...
        # Sole reality exit.  The exact provider object is passed through; the
        # boundary has no registry and cannot re-resolve by provider id.
