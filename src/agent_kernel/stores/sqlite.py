...
class SQLiteStateStore:
    ...
    _types: dict[str, type[Any]] = {
        ...
        "authorization_use": AuthorizationUse,
    }
    ...
    def save_authorization(self, value: Any) -> None:
        from agent_kernel.records.authorization import AuthorizationGrant, validate_grant
        def validate() -> None:
            if isinstance(value, AuthorizationGrant):
    ...
    def export_state(self) -> dict[str, list[dict[str, object]]]:
        ...
        try:
            from agent_kernel.records.authorization import AuthorizationGrant as _AG3  # noqa: N814
