...
from agent_kernel.public_contracts.responsibility import (
...
from agent_kernel.responsibility.admission import ResponsibilityAdmissionPolicy
...
RESPONSIBILITY_ADMISSION_PROFILE_ENV = (
    "AGENT_KERNEL_RESPONSIBILITY_ADMISSION_PROFILE"
)
BOUNDED_DOMAIN_EFFECT_FACTORY_ENV = "AGENT_KERNEL_BOUNDED_DOMAIN_EFFECT_FACTORY"
...
def contract_router(
    ...
    *,
    ...
    def get_contracts() -> dict[str, Any]:
        ...
        build_revision = os.getenv("AGENT_KERNEL_BUILD_REVISION", "").strip()
        if build_revision:
