...
def _catalog_path() -> Path:
    ...
    immutable distribution copy under ``agent_kernel/_contracts`` so the
    ...
    raise FileNotFoundError("agent-kernel canonical contract catalog is unavailable")
...
def contract_catalog() -> dict[str, Any]:
    ...
    if value.get("owner") != "agent-kernel/contracts":
