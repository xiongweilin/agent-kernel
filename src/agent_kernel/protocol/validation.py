...
from agent_kernel.records.relations import RecordRelation, RelationType, validate_relation
...
def assert_semantic_mutation_authorized(
    ...
    if isinstance(use_raw, dict):
        ...
        if isinstance(grant_raw, dict):
            try:
                from agent_kernel.records.authorization import authorization_use_covers_request
