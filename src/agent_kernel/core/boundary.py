...
from agent_kernel.core.boundary_fencing import extract_lease_generation as _extract_lease_generation
from agent_kernel.core.boundary_fencing import validate_fencing
...
from agent_kernel.core.models import Action, Event, Outcome, Step, StepAttempt, new_id, utcnow
from agent_kernel.core.qualification import (
    AssessmentContext,
    InvocationPermit,
    QualificationResolutionError,
)
from agent_kernel.core.reliability import CircuitBreaker, ReliabilityControls
...
from agent_kernel.records.authorization import CanonicalAuthorizationRequest
from agent_kernel.records.authorization import EffectClass as AuthorizationEffectClass
...
class RealityBoundary:
    ...
    def check_authorization(
        ...
        *,
        ...
        from agent_kernel.records.authorization import is_authorized_for  # noqa: PLC0415
    ...
    async def execute(self, request: CapabilityRequest, *, capability_service: Any | None = None) -> CapabilityResult:
        ...
        if self.policy_engine is not None:
            try:
                from agent_kernel.core.policies import PolicyContext
        ...
        if request.work_id and request.run_id and not self._procedure_not_applicable(request, effective):
            try:
                ...
                from agent_kernel.workflows.procedure import check_procedure
