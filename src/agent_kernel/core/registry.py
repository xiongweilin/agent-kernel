...
from agent_kernel.core.capabilities import ProviderDescriptor, ProviderHealth
...
_execution_lookup: contextvars.ContextVar[_ExecutionLookup | None] = contextvars.ContextVar(
    "agent_kernel_provider_execution_lookup",
    default=None,
)
        ...
        *,
        ...
        with self._lock:
            ...
            with suppress(Exception):
                from agent_kernel.core.boundary import _CIRCUITS
