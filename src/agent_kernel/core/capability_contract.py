...
def _builtin_contracts():
    return [
        ...
        # M8 ERP capabilities remain generic bounded effect contracts. The
        # Kernel owns their runtime floors; transaction meaning stays in the
        # calling Administrative system.
        CapabilityContract(capability="administrative.erp.purchase-order.create-draft.v1", minimum_impact_class="write-remote", effect_semantics="reconcilable", reversibility="compensatable", authorization_requirement="required", minimum_procedure_profile="standard", resource_required=True, subject_version_required=True, default_independence_requirements=[], blast_radius=1, exposure=1),
        CapabilityContract(capability="administrative.erp.purchase-order.confirm.v1", minimum_impact_class="write-remote", effect_semantics="reconcilable", reversibility="irreversible", authorization_requirement="required", minimum_procedure_profile="standard", resource_required=True, subject_version_required=True, default_independence_requirements=[], blast_radius=1, exposure=1),
        CapabilityContract(capability="administrative.erp.vendor-bill.create-draft.v1", minimum_impact_class="write-remote", effect_semantics="reconcilable", reversibility="compensatable", authorization_requirement="required", minimum_procedure_profile="standard", resource_required=True, subject_version_required=True, default_independence_requirements=[], blast_radius=1, exposure=1),
        CapabilityContract(capability="administrative.erp.expense-report.create.v1", minimum_impact_class="write-remote", effect_semantics="reconcilable", reversibility="compensatable", authorization_requirement="required", minimum_procedure_profile="standard", resource_required=True, subject_version_required=True, default_independence_requirements=[], blast_radius=1, exposure=1),
        CapabilityContract(capability="administrative.communication.message.send.v1", minimum_impact_class="write-remote", effect_semantics="reconcilable", reversibility="irreversible", authorization_requirement="required", minimum_procedure_profile="standard", resource_required=True, subject_version_required=True, default_independence_requirements=[], blast_radius=1, exposure=1),
