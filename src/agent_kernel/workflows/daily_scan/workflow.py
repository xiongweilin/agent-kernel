...
from agent_kernel.core.models import Artifact, Run, Work, new_id
from agent_kernel.records.knowledge import KnowledgeProjection, promote_to_official
    ...
    async def run(self, context: WorkflowContext, work: Work, run: Run) -> str:
        ...
        for kind, result, detail in [
            ...
            try:
                ...
                try:
                    from agent_kernel.records.models import Observation as ObservationRecord
...
class KnowledgeConsolidationWorkflow:
    ...
    async def run(self, context: WorkflowContext, work: Work, run: Run) -> str:
        ...
        try:
            from agent_kernel.compat.legacy_records import legacy_knowledge_to_projection
        ...
        try:
            ...
            context.store.save_artifact(artifact)
            from agent_kernel.records.models import Observation
