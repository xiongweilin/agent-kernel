    ...
    async def run(self, context: WorkflowContext, work: Work, run: Run) -> str:
        ...
        if needs_approval:
            ...
            if approval.status == "succeeded":
                try:
                    from agent_kernel.records.authorization import record_human_approval
        ...
        try:
            from agent_kernel.records.knowledge import KnowledgeProjection
            from agent_kernel.records.models import Assertion, Derivation, EvidenceArtifact
            ...
            derivation = Derivation(
                ...
                provider_id="agent-kernel:incident-repair",
            ...
            projection = KnowledgeProjection(
                ...
                environment_bindings=dict(work.metadata.get("environment_versions") or {"runtime": "agent-kernel"}),
