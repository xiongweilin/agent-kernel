...
Built-ins: `incident-repair` (8 steps: observe/diagnose/edit/verify/approve/merge/outcome/knowledge), `generic-task`, `daily-scan`, `knowledge-consolidation`. Add a new workflow by dropping a file under `src/agent_kernel/workflows/` and exposing it in the trigger mapping; no Core modification.
